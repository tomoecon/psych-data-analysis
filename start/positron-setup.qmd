...
![コードを入力してEnterを押すと、実行したコードの下に結果が表示されます。その下に現れる新しい `>` が、次の入力欄です。](images/positron-setup/03-console.png){fig-alt="実行したR.version.stringの結果と、その下に現れた次の入力欄 > を矢印で示している。" loading="lazy"}
